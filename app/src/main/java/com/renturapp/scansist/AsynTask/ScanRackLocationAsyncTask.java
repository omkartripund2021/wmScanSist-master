...
public class ScanRackLocationAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPostExecute(String result) {
        ...
        MyAsyncBus.getInstance().post(new ScanRackLocationAsyncTaskResultEvent(result));
    }
}