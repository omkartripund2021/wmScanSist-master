...
//Async Task to Fetch Rack Goods
public class GetRackGoodsAsyncTask extends AsyncTask<String, String, String> {
    ...
    protected void onPostExecute(String result) {
        MyAsyncBus.getInstance().post(new GetRackGoodsAsyncTaskResultEvent(result));
    }
}